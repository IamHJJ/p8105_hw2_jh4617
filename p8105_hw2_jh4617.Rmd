...
There are `r nrow(inner)` observations appears in both baseline and amyloid datafile, including key variables `r names(inner)`.

The average current age is equal to `r mean(pull(inner,current_age))`.
