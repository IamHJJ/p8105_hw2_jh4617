...
`MCI_baseline` using inner_join function. There are 471 observations and
11 variables appear in both baseline and amyloid datafile, including key
variables ” id, current_age, sex, education, apoe4, age_at_onset,
baseline, time2, time4, time6, time8”, which tells us about the amyloid
ratio in each visit.
