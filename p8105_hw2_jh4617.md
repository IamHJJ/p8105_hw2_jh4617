...
The `mci_amyloid` data has 2435 observations and 3 variables that tell
us about participant’s amyloid 42/40 ratio in each visits.
...
datafile, including 11 variables id, current_age, sex, education, apoe4,
age_at_onset, baseline, time2, time4, time6, time8, and tells us about
the amyloid ratio in each visit.
